...
<form method="post" action="">
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="sectionNumber" aria-describedby="nameHelp" name="sNumber" value="<?=$row['quantity']?>">
    <div id="nameHelp" class="form-text">Enter the quantity.</div>
  </div>
  <div class="mb-3">
  <label for="instructorList" class="form-label">Product</label>
<select class="form-select" aria-label="Select Order" id="instructorList" name="iid">
<?php
